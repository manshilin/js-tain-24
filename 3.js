...
function task3() {
  ...
  // Використовуємо Promise.allSettled який приймає масив промісів і повертає новий проміс, який вирішується,
  // коли всі проміси вирішено або відхилено
  // Він повертає масив об'єктів, кожний з яких відображає стан кожного проміса
  Promise.allSettled([promise1, promise2])
  .then((results) => {
    // Використовуємо метод map для створення нового масиву з результатами
    // Виводимо статус кожного проміса
    results.map((result) => {
